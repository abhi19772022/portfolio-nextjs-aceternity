  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-40 pt-40 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "pt-[250px] relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
      )}
      style={{
